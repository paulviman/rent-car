...
public class DatabaseService {
    ...
    public void updateCarAvailabilityDaily() {
        ...
        for (Rent rent : rents) {
            if (rent.isAvailable()) {
                if (rent.getEndDaterRent().isBefore(currentDate) || rent.getStartDateRent().isAfter(currentDate)) {
                ...
                } else if (rent.getEndDaterRent().isAfter(currentDate)||rent.getStartDateRent().isBefore(currentDate)) {
                    int carId = rent.getCarId();
                    this.setCarAvailability(carId, false);
                }
            }
        }
    }
...
//        final String PASSWORD = "postgres";
    ...
    public boolean addCarToDatabase(Car car) {
        System.out.println("CAPACITATE MOTORR" + car.getEngineCapacity());
        try {
            Connection connection = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD);
            ...
            statement.setDouble(10, car.getEngineCapacity());
...
//        final String PASSWORD = "postgres";
    ...
    public boolean editCar(Car car) {
        ...
        try {
            ...
            statement.setString(7, car.getTransmission());
            statement.setString(8, car.getFuelType());
            statement.setDouble(9, car.getEngineCapacity());
